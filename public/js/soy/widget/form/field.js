...
soy.widget.form.field = function(opt_data, opt_sb, opt_ijData) {
  ...
  if (opt_data.errors) {
    ...
    var errorList199 = opt_data.errors;
    var errorListLen199 = errorList199.length;
    for (var errorIndex199 = 0; errorIndex199 < errorListLen199; errorIndex199++) {
      var errorData199 = errorList199[errorIndex199];
      output.append('<li>', soy.$$escapeHtml(errorData199), '</li>');
    }
    output.append('</ul>');
  }
  output.append('</div>');
