...
function setupRoutes(app, subapps, config) {
	...
	app.get('/repos', render('page/repos', {
		headHtml :  '<link rel="stylesheet" href="/lib/bitbucket-widget/bitbucket-widget.min.css" />' +
                    '<style>.github-widget{margin-top: 30px;} .github-widget .github-box .link{margin-top: 1em;} .github-widget .github-stats{margin-top:0;}</style>',
		bottomHtml: '<script src="/lib/jquery.githubRepoWidget.min.js"></script>\n' +
					'<script src="/lib/bitbucket-widget/bitbucket-widget.min.js"></script>'
	}));
